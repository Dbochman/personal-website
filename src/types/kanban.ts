      ...
      cards: [
        {
          ...
          checklist: [
            { id: 'fm-1', text: 'Install framer-motion and create shared variants (src/lib/motion.ts)', completed: false },
            { id: 'fm-2', text: 'Add MotionConfig to App.tsx for reduced motion support', completed: false },
            { id: 'fm-3', text: 'Add stagger to BlogList grid', completed: false },
            { id: 'fm-4', text: 'Add stagger to ProjectGrid', completed: false },
            { id: 'fm-5', text: 'Add stagger to Analytics MetricCards', completed: false },
            { id: 'fm-6', text: 'Add scroll reveal to ExperienceSection', completed: false },
            { id: 'fm-7', text: 'Add nav item stagger to MobileNav', completed: false },
            { id: 'fm-8', text: 'Add tab content transitions to AnalyticsDashboard', completed: false },
          ],
          createdAt: '2026-01-13',
          history: [
