...
export function MonthlyHeatmap({ team, rotationWeeks }: MonthlyHeatmapProps) {
  ...
  // Generate 30 days of coverage with primary + secondary
  // Secondary is the next person in rotation (shadows before becoming primary)
  const days = Array.from({ length: 30 }, (_, dayIndex) => {
    ...
    return {
      ...
      dayOfWeek: dayIndex % 7, // 0 = Mon, 6 = Sun
