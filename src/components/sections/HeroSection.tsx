        ...
        <div className="text-center mb-8">
          ...
          <div className="relative">
            ...
            <p className="text-xl text-foreground/90 mb-8 leading-relaxed max-w-3xl mx-auto relative bg-background/30 p-6 border border-foreground/10 backdrop-blur-sm">
              Started in SRE, moved to building reliability tooling, now leading incident response. Nine years at <span className="font-mono text-foreground">Spotify</span>, <span className="font-mono text-foreground">HashiCorp</span>, and <span className="font-mono text-foreground">Nvidia</span> learning what actually works when systems fail.
            </p>
          </div>
