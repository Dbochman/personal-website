      ...
      <div className="container mx-auto max-w-4xl text-center">
        ...
        <div className="flex justify-center gap-4 mb-12">
          <a href="mailto:dylanbochman@gmail.com">
            <Button size="lg" className="bg-white text-black hover:bg-white/90 transition-all transform hover:scale-105 font-medium">
        ...
        <div className="text-white/40 text-sm border-t border-white/20 pt-8">
